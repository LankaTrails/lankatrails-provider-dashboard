...
import { fetchAllAccommodationPolicies } from "@/services/accomodation";


const AddAccommodationPolicy = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="mt-12">
        <AddPolicy  serviceType ={"accommodation"} onSuccess={handlePolicyAdded} resetTrigger={resetTrigger} />
      </div>
      {toast && (
        <AlertToast
...
export default AddAccommodationPolicy;
