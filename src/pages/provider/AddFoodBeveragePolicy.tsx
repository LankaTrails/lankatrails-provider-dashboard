...
import { fetchAllFoodPolicies } from "@/services/FoodBeverage";


const AddFoodBeveragePolicy = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="mt-12">
        <AddPolicy  serviceType ={"food-beverage"} onSuccess={handlePolicyAdded} resetTrigger={resetTrigger} />
      </div>
      {toast && (
        <AlertToast
...
export default AddFoodBeveragePolicy;
