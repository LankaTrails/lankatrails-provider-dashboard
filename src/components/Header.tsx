...
const Header = () => {
  ...
  const showUser = !!user && !['/login', '/register'].includes(location.pathname);
      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            <Link to="/destinations" className="text-gray-700 hover:text-primary-500 transition-colors">
              Destinations
            </Link>
            <Link to="/experiences" className="text-gray-700 hover:text-primary-500 transition-colors">
              Experiences
            </Link>
          ...
          <div className="hidden md:flex items-center space-x-4">
            {showUser ? (
              ...
              <>
                <Button variant="outline" className="border-primary-500 text-primary-500 hover:bg-primary-50" asChild>
            ...
            <nav className="flex flex-col space-y-4">
              ...
              {showUser ? (
                ...
                <div className="flex flex-col space-y-2 pt-4">
                  <Button variant="outline" className="w-full border-primary-500 text-primary-500 hover:bg-primary-50" asChild>
                    <Link to="/login">Login</Link>
                  </Button>
